...
In July 2024, the SSL4EO summer school brought together leading experts working on SSL and EO to teach recent advances and discuss open research questions at this intersection, with the first cohort of PhD students joining this format. For a full week, 40 participants attended the school hosted in Copenhagen, hearing from 8 invited speakers and working on mini-projects to gain hands-on experience with the methods discussed. With the generous support from [Danish e-infrastructure Consortium (DeiC)](https://www.deic.dk/en) which provided access to their GPU-cluster during the course, the participants studied the role of augmentations, learning objectives, architectural design, and sampling strategies.
